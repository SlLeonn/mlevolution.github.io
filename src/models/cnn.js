    ...
    window.MLEvolution.createModel({
      ...
      panels: {
        ...
        demo: {
          ...
          type: "cnn-compressor",
          title: "From image-like input to four DRU features",
          description:
            "This view follows the classical CNN compressor used before the quantum data re-uploading circuit.",
          pipeline: [
            {
              label: "Input",
              shape: "(batch, 57, 9, 2)",
        ...
        metrics: {
          ...
          title: "Classical CNN compressor",
          isWide: true,
          snapshot: {
            kicker: "Example implementation",
            title: "Classical part before the DRU circuit",
            intro:
              "In the hybrid DRU implementation, the CNN is a classical compressor: it turns a two-channel 57 x 9 input into a four-value feature vector, one value per qubit.",
            formulaHtml:
